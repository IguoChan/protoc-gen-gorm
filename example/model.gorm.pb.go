...
func UserModelScore(x float32) mysqlx.Option {
	return func(db *gorm.DB) *gorm.DB {
		return db.Where("score= ?", x)
	}
}

func UserModelCreateTime(x *timestamp.Timestamp) mysqlx.Option {
	return func(db *gorm.DB) *gorm.DB {
		return db.Where("create_time= ?", x)
	}
}

func UserModelUpdateTime(x *timestamp.Timestamp) mysqlx.Option {
	return func(db *gorm.DB) *gorm.DB {
		return db.Where("update_time= ?", x)
	}
}

func UserModelDeletedTime(x *timestamp.Timestamp) mysqlx.Option {
	return func(db *gorm.DB) *gorm.DB {
		return db.Where("deleted_time= ?", x)
	}
}

func UserModelDate(x *timestamp.Timestamp) mysqlx.Option {
	return func(db *gorm.DB) *gorm.DB {
		return db.Where("date= ?", x)
	}
}

func UserModelExtra(x []byte) mysqlx.Option {
	return func(db *gorm.DB) *gorm.DB {
		return db.Where("extra= ?", x)
	}
}

func UserModelStatus(x Status) mysqlx.Option {
	return func(db *gorm.DB) *gorm.DB {
		return db.Where("status= ?", x)
	}
}

func UserModelStatus1(x Status) mysqlx.Option {
	return func(db *gorm.DB) *gorm.DB {
		return db.Where("status1= ?", x)
	}
}

func UserModelStatus2(x Status) mysqlx.Option {
	return func(db *gorm.DB) *gorm.DB {
		return db.Where("status2= ?", x)
	}
}
