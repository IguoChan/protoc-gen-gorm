...
func TestDaoCreateSaveFirstFindDelete(t *testing.T) {
...
func TestDaoCreateInBatches(t *testing.T) {
	ctx := context.Background()
	dao := userDao(t)
...
func TestDaoTakeLastAndLockingFinders(t *testing.T) {
	ctx := context.Background()
	dao := userDao(t)
	u := seedUser(t, "finder")
...
func TestDaoFindInBatches(t *testing.T) {
	ctx := context.Background()
	dao := userDao(t)
...
func TestDaoFirstOrInit(t *testing.T) {
	ctx := context.Background()
	dao := userDao(t)
...
func TestDaoFirstOrCreate(t *testing.T) {
	ctx := context.Background()
	dao := userDao(t)
...
func TestDaoUpdateFunctions(t *testing.T) {
	ctx := context.Background()
	dao := userDao(t)
...
func TestDaoCountPluckScanQuery(t *testing.T) {
	ctx := context.Background()
	dao := userDao(t)
	u := seedUser(t, "query")
...
func TestDaoRowRowsAndExec(t *testing.T) {
	ctx := context.Background()
	dao := userDao(t)
	u := seedUser(t, "rows")
...
func TestDaoDeleteModelAndUnscopedDelete(t *testing.T) {
	ctx := context.Background()
	dao := userDao(t)
...
func TestDaoInnerJoins(t *testing.T) {
	ctx := context.Background()
	dao := userDao(t)
	u := seedUser(t, "dao_inner_join")
